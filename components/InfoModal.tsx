...
export const InfoModal: React.FC<InfoModalProps> = ({ onClose }) => {
  return (
    ...
    >
      <div 
        className="bg-gray-800 border border-indigo-500/50 rounded-lg shadow-2xl max-w-2xl w-full p-6 text-gray-300 relative max-h-[90vh] overflow-y-auto"
        onClick={(e) => e.stopPropagation()}
      >
        <button onClick={onClose} className="absolute top-4 right-4 text-gray-500 hover:text-white">
          <Icon name="close" className="w-6 h-6" />
        </button>
        <h2 style={{ fontFamily: 'Cinzel, serif' }} className="text-2xl font-bold mb-4 text-purple-300">
        ...
        <div className="space-y-4 text-gray-400">
          ...
          <div>
            <h3 className="font-semibold text-lg text-purple-400 mb-1">Core Mechanic: The Mandate to Lie</h3>
            <p>
           ...
           <div>
            <h3 className="font-semibold text-lg text-purple-400 mb-1">Research Tools & Features</h3>
          ...
          <div>
            <h3 className="font-semibold text-lg text-purple-400 mb-1">Interactive Analysis</h3>
            <ul className="list-disc list-inside space-y-1 pl-2">
                <li><span className="font-bold text-yellow-400">Truth Alert (AI-Flagged):</span> The Oracle is programmed to self-report when it accidentally states a verifiable truth.</li>
